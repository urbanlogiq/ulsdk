...
#ifndef FLATBUFFERS_GENERATED_TENSOR_H_
#define FLATBUFFERS_GENERATED_TENSOR_H_
...
struct TensorDim::Traits {
  using type = TensorDim;
  static auto constexpr Create = CreateTensorDim;
};
...
template<> inline const RunEndEncoded *Tensor::type_as<RunEndEncoded>() const {
  return type_as_RunEndEncoded();
}

template<> inline const BinaryView *Tensor::type_as<BinaryView>() const {
  return type_as_BinaryView();
}

template<> inline const Utf8View *Tensor::type_as<Utf8View>() const {
  return type_as_Utf8View();
}

template<> inline const ListView *Tensor::type_as<ListView>() const {
  return type_as_ListView();
}

template<> inline const LargeListView *Tensor::type_as<LargeListView>() const {
...
inline const Tensor *GetTensor(const void *buf) {
  return ::flatbuffers::GetRoot<Tensor>(buf);
}

inline const Tensor *GetSizePrefixedTensor(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Tensor>(buf);
}

inline bool VerifyTensorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Tensor>(nullptr);
}

inline bool VerifySizePrefixedTensorBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Tensor>(nullptr);
}

inline void FinishTensorBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Tensor> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_TENSOR_H_
