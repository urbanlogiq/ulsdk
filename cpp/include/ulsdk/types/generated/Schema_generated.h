...
struct Null::Traits {
  using type = Null;
  static auto constexpr Create = CreateNull;
};
...
struct Struct_::Traits {
  using type = Struct_;
  static auto constexpr Create = CreateStruct_;
};
...
struct List::Traits {
  using type = List;
  static auto constexpr Create = CreateList;
};
...
struct FixedSizeList::Traits {
  using type = FixedSizeList;
  static auto constexpr Create = CreateFixedSizeList;
};
...
struct Union::Traits {
  using type = Union;
  static auto constexpr Create = CreateUnion;
};
...
struct FloatingPoint::Traits {
  using type = FloatingPoint;
  static auto constexpr Create = CreateFloatingPoint;
};
...
struct Utf8::Traits {
  using type = Utf8;
  static auto constexpr Create = CreateUtf8;
};
...
struct Binary::Traits {
  using type = Binary;
  static auto constexpr Create = CreateBinary;
};
...
struct LargeUtf8::Traits {
  using type = LargeUtf8;
  static auto constexpr Create = CreateLargeUtf8;
};
...
struct LargeBinary::Traits {
  using type = LargeBinary;
...
struct FixedSizeBinary::Traits {
  using type = FixedSizeBinary;
  static auto constexpr Create = CreateFixedSizeBinary;
};
...
struct Decimal::Traits {
  using type = Decimal;
  static auto constexpr Create = CreateDecimal;
};
...
struct Date::Traits {
  using type = Date;
  static auto constexpr Create = CreateDate;
};
...
struct Time::Traits {
  using type = Time;
  static auto constexpr Create = CreateTime;
};
...
struct Interval::Traits {
  using type = Interval;
  static auto constexpr Create = CreateInterval;
};
...
struct Duration::Traits {
  using type = Duration;
  static auto constexpr Create = CreateDuration;
};
...
struct DictionaryEncoding::Traits {
  using type = DictionaryEncoding;
  static auto constexpr Create = CreateDictionaryEncoding;
};
...
struct Schema FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<Feature> *features() const {
    return GetPointer<const ::flatbuffers::Vector<Feature> *>(VT_FEATURES);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct SchemaBuilder {
  ...
  void add_features(::flatbuffers::Offset<::flatbuffers::Vector<Feature>> features) {
...
inline ::flatbuffers::Offset<Schema> CreateSchema(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<KeyValue>>> custom_metadata = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<Feature>> features = 0) {
...
inline ::flatbuffers::Offset<Schema> CreateSchemaDirect(
  ...
  auto custom_metadata__ = custom_metadata ? _fbb.CreateVector<::flatbuffers::Offset<KeyValue>>(*custom_metadata) : 0;
  auto features__ = features ? _fbb.CreateVector<Feature>(*features) : 0;
  return CreateSchema(
      _fbb,
      endianness,
      fields__,
