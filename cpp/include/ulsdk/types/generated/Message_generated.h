...
struct FieldNode::Traits {
  using type = FieldNode;
};
...
struct BodyCompression::Traits {
  using type = BodyCompression;
  static auto constexpr Create = CreateBodyCompression;
};
...
struct RecordBatch::Traits {
  using type = RecordBatch;
  static auto constexpr Create = CreateRecordBatch;
};
...
struct DictionaryBatch::Traits {
  using type = DictionaryBatch;
  static auto constexpr Create = CreateDictionaryBatch;
};
