...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/VERSION")
  file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/VERSION" UL_VERSION_LINE LIMIT_COUNT 1)
  if(UL_VERSION_LINE MATCHES "^([0-9]+)\\.([0-9]+)\\.([0-9]+)$")
    set(VERSION_MAJOR ${CMAKE_MATCH_1})
    set(VERSION_MINOR ${CMAKE_MATCH_2})
    set(VERSION_PATCH ${CMAKE_MATCH_3})
  else()
    message(WARNING "VERSION file content \"${UL_VERSION_LINE}\" does not match <major>.<minor>.<patch>")
  endif()
