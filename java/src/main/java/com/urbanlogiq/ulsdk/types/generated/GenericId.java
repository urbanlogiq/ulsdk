...
public final class GenericId extends com.google.flatbuffers.Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_5_26(); }
  public static GenericId getRootAsGenericId(ByteBuffer _bb) { return getRootAsGenericId(_bb, new GenericId()); }
  public static GenericId getRootAsGenericId(ByteBuffer _bb, GenericId obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public GenericId __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createGenericId(FlatBufferBuilder builder,
      int bOffset) {
    builder.startTable(1);
    GenericId.addB(builder, bOffset);
    return GenericId.endGenericId(builder);
  }

  public static void startGenericId(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static int endGenericId(FlatBufferBuilder builder) {
  ...
  public static final class _Vector extends BaseVector {
    ...
    public GenericId get(int j) { return get(new GenericId(), j); }
    public GenericId get(GenericId obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
