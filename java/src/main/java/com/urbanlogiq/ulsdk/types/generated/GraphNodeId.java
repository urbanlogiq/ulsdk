...
public final class GraphNodeId extends com.google.flatbuffers.Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_25_2_10(); }
  public static GraphNodeId getRootAsGraphNodeId(ByteBuffer _bb) { return getRootAsGraphNodeId(_bb, new GraphNodeId()); }
  public static GraphNodeId getRootAsGraphNodeId(ByteBuffer _bb, GraphNodeId obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public GraphNodeId __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createGraphNodeId(FlatBufferBuilder builder,
      int bOffset) {
  ...
  public static void startGraphNodeId(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static int endGraphNodeId(FlatBufferBuilder builder) {
  ...
  public static final class _Vector extends BaseVector {
    ...
    public GraphNodeId get(int j) { return get(new GraphNodeId(), j); }
    public GraphNodeId get(GraphNodeId obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
