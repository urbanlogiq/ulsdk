...
public final class B2cId extends com.google.flatbuffers.Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_25_2_10(); }
  public static B2cId getRootAsB2cId(ByteBuffer _bb) { return getRootAsB2cId(_bb, new B2cId()); }
  public static B2cId getRootAsB2cId(ByteBuffer _bb, B2cId obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public B2cId __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createB2cId(FlatBufferBuilder builder,
      int bOffset) {
  ...
  public static void startB2cId(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static int endB2cId(FlatBufferBuilder builder) {
  ...
  public static final class _Vector extends BaseVector {
    ...
    public B2cId get(int j) { return get(new B2cId(), j); }
    public B2cId get(B2cId obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
