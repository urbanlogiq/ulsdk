...
public final class ObjectId extends com.google.flatbuffers.Table {
  ...
  public static void startObjectId(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class _Vector extends BaseVector {
    ...
    public ObjectId get(int j) { return get(new ObjectId(), j); }
    public ObjectId get(ObjectId obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
