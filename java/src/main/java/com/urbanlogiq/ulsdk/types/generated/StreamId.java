...
public final class StreamId extends com.google.flatbuffers.Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_5_26(); }
  public static StreamId getRootAsStreamId(ByteBuffer _bb) { return getRootAsStreamId(_bb, new StreamId()); }
  public static StreamId getRootAsStreamId(ByteBuffer _bb, StreamId obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public StreamId __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createStreamId(FlatBufferBuilder builder,
      int bOffset) {
  ...
  public static void startStreamId(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static int endStreamId(FlatBufferBuilder builder) {
  ...
  public static final class _Vector extends BaseVector {
    ...
    public StreamId get(int j) { return get(new StreamId(), j); }
    public StreamId get(StreamId obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
