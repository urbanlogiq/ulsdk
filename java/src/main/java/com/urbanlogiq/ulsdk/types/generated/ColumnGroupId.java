...
public final class ColumnGroupId extends com.google.flatbuffers.Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_25_2_10(); }
  public static ColumnGroupId getRootAsColumnGroupId(ByteBuffer _bb) { return getRootAsColumnGroupId(_bb, new ColumnGroupId()); }
  public static ColumnGroupId getRootAsColumnGroupId(ByteBuffer _bb, ColumnGroupId obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public ColumnGroupId __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createColumnGroupId(FlatBufferBuilder builder,
      int bOffset) {
  ...
  public static void startColumnGroupId(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static int endColumnGroupId(FlatBufferBuilder builder) {
  ...
  public static final class _Vector extends BaseVector {
    ...
    public ColumnGroupId get(int j) { return get(new ColumnGroupId(), j); }
    public ColumnGroupId get(ColumnGroupId obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
