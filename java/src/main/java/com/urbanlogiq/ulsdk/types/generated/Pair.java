...
public final class Pair extends com.google.flatbuffers.Table {
  ...
  public static int createPair(FlatBufferBuilder builder,
    ...
    Pair.addValueType(builder, valueType);
    return Pair.endPair(builder);
  }

  public static void startPair(FlatBufferBuilder builder) { builder.startTable(3); }
