...
import { DictionaryKind } from './dictionary-kind';
import { Int, IntT } from './int';
export declare class DictionaryEncoding implements flatbuffers.IUnpackableObject<DictionaryEncodingT> {
    ...
    unpack(): DictionaryEncodingT;
    unpackTo(_o: DictionaryEncodingT): void;
}
export declare class DictionaryEncodingT implements flatbuffers.IGeneratedObject {
    id: bigint;
    indexType: IntT | null;
    isOrdered: boolean;
    dictionaryKind: DictionaryKind;
    constructor(id?: bigint, indexType?: IntT | null, isOrdered?: boolean, dictionaryKind?: DictionaryKind);
