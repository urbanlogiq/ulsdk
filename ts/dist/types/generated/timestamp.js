...
export class Timestamp {
    ...
    unpack() {
        return new TimestampT(this.unit(), this.timezone());
    }
    unpackTo(_o) {
        _o.unit = this.unit();
...
export class TimestampT {
    unit;
    timezone;
    constructor(unit = TimeUnit.SECOND, timezone = null) {
        this.unit = unit;
        this.timezone = timezone;
    }
    pack(builder) {
        const timezone = (this.timezone !== null ? builder.createString(this.timezone) : 0);
        return Timestamp.createTimestamp(builder, this.unit, timezone);
    }
}
