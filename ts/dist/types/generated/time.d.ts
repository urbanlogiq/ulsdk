 ...
 */
export declare class Time implements flatbuffers.IUnpackableObject<TimeT> {
...
export declare class TimeT implements flatbuffers.IGeneratedObject {
    unit: TimeUnit;
    bitWidth: number;
    constructor(unit?: TimeUnit, bitWidth?: number);
