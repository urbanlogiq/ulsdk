...
import { UnionMode } from './union-mode';
/**
 ...
 */
export declare class Union implements flatbuffers.IUnpackableObject<UnionT> {
    ...
    unpack(): UnionT;
    unpackTo(_o: UnionT): void;
}
export declare class UnionT implements flatbuffers.IGeneratedObject {
    mode: UnionMode;
    typeIds: (number)[];
    constructor(mode?: UnionMode, typeIds?: (number)[]);
