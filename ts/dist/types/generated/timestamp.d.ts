 ...
 */
export declare class Timestamp implements flatbuffers.IUnpackableObject<TimestampT> {
...
export declare class TimestampT implements flatbuffers.IGeneratedObject {
    unit: TimeUnit;
    timezone: string | Uint8Array | null;
    constructor(unit?: TimeUnit, timezone?: string | Uint8Array | null);
