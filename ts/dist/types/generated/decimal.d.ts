 ...
 * in the Schema.
 */
export declare class Decimal implements flatbuffers.IUnpackableObject<DecimalT> {
    ...
    unpack(): DecimalT;
    unpackTo(_o: DecimalT): void;
}
export declare class DecimalT implements flatbuffers.IGeneratedObject {
    precision: number;
    scale: number;
    bitWidth: number;
