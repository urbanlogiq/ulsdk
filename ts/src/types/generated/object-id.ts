...
export class ObjectId implements flatbuffers.IUnpackableObject<ObjectIdT> {
...
static startObjectId(builder:flatbuffers.Builder) {
...
export class ObjectIdT implements flatbuffers.IGeneratedObject {
constructor(
  public b: (number)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ObjectId.createObjectId(builder,
    b
  );
}
}