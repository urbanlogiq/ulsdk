...
unpack(): SchemaT {
  return new SchemaT(
    ...
    this.bb!.createScalarList<bigint>(this.features.bind(this), this.featuresLength())
  );
}
...
unpackTo(_o: SchemaT): void {
  ...
  _o.features = this.bb!.createScalarList<bigint>(this.features.bind(this), this.featuresLength());
}
}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Schema.createSchema(builder,
    this.endianness,
    fields,
    customMetadata,
    features
