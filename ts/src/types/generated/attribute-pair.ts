...
export class AttributePair implements flatbuffers.IUnpackableObject<AttributePairT> {
...
static startAttributePair(builder:flatbuffers.Builder) {
...
export class AttributePairT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AttributePair.createAttributePair(builder,
    key,
    value
  );
}
