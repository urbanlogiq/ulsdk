 ...
 */
export class Union implements flatbuffers.IUnpackableObject<UnionT> {
...
unpack(): UnionT {
  return new UnionT(
    this.mode(),
    this.bb!.createScalarList<number>(this.typeIds.bind(this), this.typeIdsLength())
  );
}
...
unpackTo(_o: UnionT): void {
  _o.mode = this.mode();
  _o.typeIds = this.bb!.createScalarList<number>(this.typeIds.bind(this), this.typeIdsLength());
}
}

export class UnionT implements flatbuffers.IGeneratedObject {
constructor(
  public mode: UnionMode = UnionMode.Sparse,
  public typeIds: (number)[] = []
){}


pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const typeIds = Union.createTypeIdsVector(builder, this.typeIds);

  return Union.createUnion(builder,
    this.mode,
    typeIds
  );
}
