...
export class FixedSizeList implements flatbuffers.IUnpackableObject<FixedSizeListT> {
...
export class FixedSizeListT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return FixedSizeList.createFixedSizeList(builder,
    this.listSize
  );
}
}