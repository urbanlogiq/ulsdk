...
export class AccessControlList implements flatbuffers.IUnpackableObject<AccessControlListT> {
...
static startAccessControlList(builder:flatbuffers.Builder) {
...
unpack(): AccessControlListT {
  return new AccessControlListT(
    this.bb!.createObjList<Role, RoleT>(this.roles.bind(this), this.rolesLength()),
    (this.extends_() !== null ? this.extends_()!.unpack() : null)
  );
}


unpackTo(_o: AccessControlListT): void {
  _o.roles = this.bb!.createObjList<Role, RoleT>(this.roles.bind(this), this.rolesLength());
  _o.extends_ = (this.extends_() !== null ? this.extends_()!.unpack() : null);
}
}

export class AccessControlListT implements flatbuffers.IGeneratedObject {
constructor(
  public roles: (RoleT)[] = [],
  public extends_: ObjectIdT|null = null
){}
