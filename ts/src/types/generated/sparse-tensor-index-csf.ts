 ...
 */
export class SparseTensorIndexCSF implements flatbuffers.IUnpackableObject<SparseTensorIndexCSFT> {
...
unpack(): SparseTensorIndexCSFT {
  return new SparseTensorIndexCSFT(
    (this.indptrType() !== null ? this.indptrType()!.unpack() : null),
    this.bb!.createObjList<Buffer, BufferT>(this.indptrBuffers.bind(this), this.indptrBuffersLength()),
    (this.indicesType() !== null ? this.indicesType()!.unpack() : null),
    this.bb!.createObjList<Buffer, BufferT>(this.indicesBuffers.bind(this), this.indicesBuffersLength()),
    this.bb!.createScalarList<number>(this.axisOrder.bind(this), this.axisOrderLength())
  );
}


unpackTo(_o: SparseTensorIndexCSFT): void {
  _o.indptrType = (this.indptrType() !== null ? this.indptrType()!.unpack() : null);
  _o.indptrBuffers = this.bb!.createObjList<Buffer, BufferT>(this.indptrBuffers.bind(this), this.indptrBuffersLength());
  _o.indicesType = (this.indicesType() !== null ? this.indicesType()!.unpack() : null);
  _o.indicesBuffers = this.bb!.createObjList<Buffer, BufferT>(this.indicesBuffers.bind(this), this.indicesBuffersLength());
  _o.axisOrder = this.bb!.createScalarList<number>(this.axisOrder.bind(this), this.axisOrderLength());
}
}

export class SparseTensorIndexCSFT implements flatbuffers.IGeneratedObject {
constructor(
  public indptrType: IntT|null = null,
  public indptrBuffers: (BufferT)[] = [],
  public indicesType: IntT|null = null,
  public indicesBuffers: (BufferT)[] = [],
  public axisOrder: (number)[] = []
){}


pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const indptrType = (this.indptrType !== null ? this.indptrType!.pack(builder) : 0);
  const indptrBuffers = builder.createStructOffsetList(this.indptrBuffers, SparseTensorIndexCSF.startIndptrBuffersVector);
  const indicesType = (this.indicesType !== null ? this.indicesType!.pack(builder) : 0);
  const indicesBuffers = builder.createStructOffsetList(this.indicesBuffers, SparseTensorIndexCSF.startIndicesBuffersVector);
  const axisOrder = SparseTensorIndexCSF.createAxisOrderVector(builder, this.axisOrder);

  SparseTensorIndexCSF.startSparseTensorIndexCSF(builder);
  SparseTensorIndexCSF.addIndptrType(builder, indptrType);
  SparseTensorIndexCSF.addIndptrBuffers(builder, indptrBuffers);
  SparseTensorIndexCSF.addIndicesType(builder, indicesType);
  SparseTensorIndexCSF.addIndicesBuffers(builder, indicesBuffers);
  SparseTensorIndexCSF.addAxisOrder(builder, axisOrder);
