...
export class StreamId implements flatbuffers.IUnpackableObject<StreamIdT> {
...
static startStreamId(builder:flatbuffers.Builder) {
...
export class StreamIdT implements flatbuffers.IGeneratedObject {
constructor(
  public b: (number)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return StreamId.createStreamId(builder,
    b
  );
}
}