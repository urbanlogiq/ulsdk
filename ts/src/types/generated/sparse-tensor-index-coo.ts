 ...
 */
export class SparseTensorIndexCOO implements flatbuffers.IUnpackableObject<SparseTensorIndexCOOT> {
...
unpack(): SparseTensorIndexCOOT {
  return new SparseTensorIndexCOOT(
    (this.indicesType() !== null ? this.indicesType()!.unpack() : null),
    this.bb!.createScalarList<bigint>(this.indicesStrides.bind(this), this.indicesStridesLength()),
...
unpackTo(_o: SparseTensorIndexCOOT): void {
  _o.indicesType = (this.indicesType() !== null ? this.indicesType()!.unpack() : null);
  _o.indicesStrides = this.bb!.createScalarList<bigint>(this.indicesStrides.bind(this), this.indicesStridesLength());
  _o.indicesBuffer = (this.indicesBuffer() !== null ? this.indicesBuffer()!.unpack() : null);
  _o.isCanonical = this.isCanonical();
}
}

export class SparseTensorIndexCOOT implements flatbuffers.IGeneratedObject {
constructor(
  public indicesType: IntT|null = null,
  public indicesStrides: (bigint)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const indicesStrides = SparseTensorIndexCOO.createIndicesStridesVector(builder, this.indicesStrides);
  ...
  SparseTensorIndexCOO.addIndicesBuffer(builder, (this.indicesBuffer !== null ? this.indicesBuffer!.pack(builder) : 0));
  SparseTensorIndexCOO.addIsCanonical(builder, this.isCanonical);

  return SparseTensorIndexCOO.endSparseTensorIndexCOO(builder);
}
}