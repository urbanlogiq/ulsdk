...
export class GraphNodeId implements flatbuffers.IUnpackableObject<GraphNodeIdT> {
...
static startGraphNodeId(builder:flatbuffers.Builder) {
...
export class GraphNodeIdT implements flatbuffers.IGeneratedObject {
constructor(
  public b: (number)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return GraphNodeId.createGraphNodeId(builder,
    b
  );
}
}