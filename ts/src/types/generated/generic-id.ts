...
export class GenericId implements flatbuffers.IUnpackableObject<GenericIdT> {
...
static startGenericId(builder:flatbuffers.Builder) {
...
export class GenericIdT implements flatbuffers.IGeneratedObject {
constructor(
  public b: (number)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return GenericId.createGenericId(builder,
    b
  );
}
}