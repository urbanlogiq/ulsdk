...
export class VBytes implements flatbuffers.IUnpackableObject<VBytesT> {
...
static startVBytes(builder:flatbuffers.Builder) {
...
export class VBytesT implements flatbuffers.IGeneratedObject {
constructor(
  public v: (number)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return VBytes.createVBytes(builder,
    v
  );
}
}