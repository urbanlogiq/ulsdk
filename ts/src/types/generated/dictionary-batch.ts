 ...
 * flag
 */
export class DictionaryBatch implements flatbuffers.IUnpackableObject<DictionaryBatchT> {
...
unpack(): DictionaryBatchT {
  return new DictionaryBatchT(
    this.id(),
...
unpackTo(_o: DictionaryBatchT): void {
  _o.id = this.id();
  _o.data = (this.data() !== null ? this.data()!.unpack() : null);
  _o.isDelta = this.isDelta();
}
}

export class DictionaryBatchT implements flatbuffers.IGeneratedObject {
constructor(
  public id: bigint = BigInt('0'),
  public data: RecordBatchT|null = null,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  DictionaryBatch.addId(builder, this.id);
  DictionaryBatch.addData(builder, data);
