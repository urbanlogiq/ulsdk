...
export class ColumnGroupId implements flatbuffers.IUnpackableObject<ColumnGroupIdT> {
...
static startColumnGroupId(builder:flatbuffers.Builder) {
...
export class ColumnGroupIdT implements flatbuffers.IGeneratedObject {
constructor(
  public b: (number)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ColumnGroupId.createColumnGroupId(builder,
    b
  );
}
}