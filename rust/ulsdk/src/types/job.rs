...
impl TryFrom<i8> for Status {
    ...
    fn try_from(v: i8) -> Result<Self, crate::error::Error> {
        Status::from_repr(v).ok_or(crate::error::Error::InvalidEnumValue(v as i64))
    }
}
...
impl TryFrom<i32> for TaskErrorTy {
    ...
    fn try_from(v: i32) -> Result<Self, crate::error::Error> {
        TaskErrorTy::from_repr(v).ok_or(crate::error::Error::InvalidEnumValue(v as i64))
    }
}
...
impl TryFrom<i32> for TaskPriority {
    type Error = crate::error::Error;
    fn try_from(v: i32) -> Result<Self, crate::error::Error> {
        TaskPriority::from_repr(v).ok_or(crate::error::Error::InvalidEnumValue(v as i64))
    }
}
...
impl crate::FbsSerde for EmbeddedTable {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsEmbeddedTable>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for DeprecatedRunSpec {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsDeprecatedRunSpec>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for DeprecatedTaskParameter {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs =
            flatbuffers::size_prefixed_root_with_opts::<FbsDeprecatedTaskParameter>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for Edge {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsEdge>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for Node {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsNode>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for ParamIndices {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsParamIndices>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for RunSpec {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsRunSpec>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for Schematic {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsSchematic>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for TaskList {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsTaskList>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for TaskParameter {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsTaskParameter>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
