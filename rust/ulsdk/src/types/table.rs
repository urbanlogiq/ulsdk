...
impl Modify {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsModify>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl Delete {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsDelete>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl Restore {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsRestore>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl Set {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsSet>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl RmRow {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsRmRow>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl RestoreRow {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsRestoreRow>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl Append {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsAppend>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl ChangeOpEntry {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsChangeOpEntry>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl ChangeSet {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsChangeSet>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl DiffStream {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsDiffStream>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl History {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsHistory>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl OpEntry {
    ...
    pub fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsOpEntry>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
mod tests {
    ...
    fn test_append() {
        ...
        let t1 = Append::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_change_op_entry() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = ChangeOpEntry::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_change_set() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = ChangeSet::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_delete() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = Delete::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_diff_stream() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = DiffStream::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_history() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = History::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_modify() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = Modify::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_op_entry() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = OpEntry::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_restore() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = Restore::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_restore_row() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = RestoreRow::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_rm_row() {
        ...
        let buf = t0.to_fbs_bytes();
        let t1 = RmRow::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
    ...
    fn test_set() {
        let t0 = Set::default();
        let buf = t0.to_fbs_bytes();
        let t1 = Set::from_fbs_bytes(buf.as_slice()).unwrap();
        assert_eq!(t0, t1);
    }
}
