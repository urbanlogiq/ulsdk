...
impl TryFrom<u32> for AxisType {
    type Error = crate::error::Error;
    fn try_from(v: u32) -> Result<Self, crate::error::Error> {
        AxisType::from_repr(v).ok_or(crate::error::Error::InvalidEnumValue(v as i64))
    }
}
...
impl crate::FbsSerde for Stream {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsStream>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
