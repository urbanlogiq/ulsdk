...
impl TryFrom<u32> for EntryTy {
    type Error = crate::error::Error;
    fn try_from(v: u32) -> Result<Self, crate::error::Error> {
        EntryTy::from_repr(v).ok_or(crate::error::Error::InvalidEnumValue(v as i64))
    }
}
...
impl TryFrom<i8> for StorageTier {
    type Error = crate::error::Error;
    fn try_from(v: i8) -> Result<Self, crate::error::Error> {
        StorageTier::from_repr(v).ok_or(crate::error::Error::InvalidEnumValue(v as i64))
    }
}
...
impl crate::FbsSerde for File {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsFile>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for Directory {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsDirectory>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for ObjectRef {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
...
impl crate::FbsSerde for ListFile {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsListFile>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for ListDirectory {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsListDirectory>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for ListObject {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
...
impl crate::FbsSerde for TopLevelDirectory {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsTopLevelDirectory>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for Chunk {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsChunk>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for DirectoryEntry {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsDirectoryEntry>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for DirectoryList {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsDirectoryList>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for ListSlot {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsListSlot>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for MoveRequest {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsMoveRequest>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for NewLink {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsNewLink>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
