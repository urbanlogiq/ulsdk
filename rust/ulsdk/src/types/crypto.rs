...
impl crate::FbsSerde for Sha256 {
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsSha256>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for CryptHeader {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsCryptHeader>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for EncryptedObject {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsEncryptedObject>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
...
impl crate::FbsSerde for Signature {
    fn to_fbs_bytes(&self) -> Vec<u8> {
        let mut bldr = flatbuffers::FlatBufferBuilder::new();
        let offset = self.serialize_to(&mut bldr);
        bldr.finish_size_prefixed(offset, None);
    ...
    fn from_fbs_bytes(bytes: &[u8]) -> Result<Self, flatbuffers::InvalidFlatbuffer> {
        ...
        let fbs = flatbuffers::size_prefixed_root_with_opts::<FbsSignature>(&opts, bytes)?;
        Ok(Self::from(fbs))
    }
}
