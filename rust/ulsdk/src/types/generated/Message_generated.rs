...
use super::SparseTensor_generated::*;
...
impl Serialize for FieldNode {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("FieldNode", 2)?;
        s.serialize_field("length", &self.length())?;
        s.serialize_field("null_count", &self.null_count())?;
        s.end()
    }
}
...
impl Serialize for BodyCompression<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("BodyCompression", 2)?;
        s.serialize_field("codec", &self.codec())?;
...
impl Serialize for RecordBatch<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("RecordBatch", 5)?;
        s.serialize_field("length", &self.length())?;
        ...
        if let Some(f) = self.buffers() {
            s.serialize_field("buffers", &f)?;
        } else {
            s.skip_field("buffers")?;
        }
        if let Some(f) = self.compression() {
            s.serialize_field("compression", &f)?;
        } else {
            s.skip_field("compression")?;
        }
        if let Some(f) = self.variadicBufferCounts() {
            s.serialize_field("variadicBufferCounts", &f)?;
        } else {
            s.skip_field("variadicBufferCounts")?;
        }
        s.end()
    }
}
...
impl Serialize for DictionaryBatch<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("DictionaryBatch", 3)?;
        ...
        s.serialize_field("isDelta", &self.isDelta())?;
        s.end()
    }
}
...
impl Serialize for Message<'_> {
        ...
        S: Serializer,
    {
        ...
        s.serialize_field("header_type", &self.header_type())?;
        match self.header_type() {
            MessageHeader::NONE => (),
            MessageHeader::Schema => {
                let f = self
                    .header_as_schema()
                    .expect("Invalid union table, expected `MessageHeader::Schema`.");
                s.serialize_field("header", &f)?;
            }
            MessageHeader::DictionaryBatch => {
                let f = self
                    .header_as_dictionary_batch()
                    .expect("Invalid union table, expected `MessageHeader::DictionaryBatch`.");
                s.serialize_field("header", &f)?;
            }
            MessageHeader::RecordBatch => {
                let f = self
                    .header_as_record_batch()
                    .expect("Invalid union table, expected `MessageHeader::RecordBatch`.");
                s.serialize_field("header", &f)?;
            }
            MessageHeader::Tensor => {
                let f = self
                    .header_as_tensor()
                    .expect("Invalid union table, expected `MessageHeader::Tensor`.");
                s.serialize_field("header", &f)?;
            }
            MessageHeader::SparseTensor => {
                let f = self
                    .header_as_sparse_tensor()
                    .expect("Invalid union table, expected `MessageHeader::SparseTensor`.");
                s.serialize_field("header", &f)?;
            }
            _ => unimplemented!(),
        }
        s.serialize_field("bodyLength", &self.bodyLength())?;
