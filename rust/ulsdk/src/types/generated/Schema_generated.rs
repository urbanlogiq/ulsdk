...
impl Serialize for ListView<'_> {
    ...
    where
        S: Serializer,
    {
        let s = serializer.serialize_struct("ListView", 0)?;
        s.end()
    }
}
...
impl Serialize for LargeListView<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let s = serializer.serialize_struct("LargeListView", 0)?;
        s.end()
    }
}
...
impl Serialize for Utf8View<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let s = serializer.serialize_struct("Utf8View", 0)?;
        s.end()
    }
}
...
impl Serialize for BinaryView<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let s = serializer.serialize_struct("BinaryView", 0)?;
        s.end()
    }
}
...
impl Serialize for RunEndEncoded<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let s = serializer.serialize_struct("RunEndEncoded", 0)?;
        s.end()
    }
}
