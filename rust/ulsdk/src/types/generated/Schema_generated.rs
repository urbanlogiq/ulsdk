...
impl Serialize for MetadataVersion {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("MetadataVersion", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for Feature {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("Feature", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for UnionMode {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("UnionMode", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for Precision {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("Precision", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for DateUnit {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("DateUnit", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for TimeUnit {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("TimeUnit", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for IntervalUnit {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("IntervalUnit", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for Type {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("Type", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for DictionaryKind {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("DictionaryKind", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for Endianness {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("Endianness", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for Null<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("Null", 0)?;
    s.end()
  }
}
...
impl Serialize for Struct_<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("Struct_", 0)?;
    s.end()
  }
}
...
impl Serialize for List<'_> {
  ...
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("List", 0)?;
    s.end()
  }
}
...
impl Serialize for LargeList<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("LargeList", 0)?;
    s.end()
  }
}
...
impl Serialize for FixedSizeList<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("FixedSizeList", 1)?;
      s.serialize_field("listSize", &self.listSize())?;
    s.end()
  }
}
...
impl Serialize for Map<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Map", 1)?;
      s.serialize_field("keysSorted", &self.keysSorted())?;
    s.end()
  }
}
...
impl Serialize for Union<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Union", 2)?;
      ...
      if let Some(f) = self.typeIds() {
        s.serialize_field("typeIds", &f)?;
      } else {
        s.skip_field("typeIds")?;
      }
    s.end()
  }
}
...
impl Serialize for Int<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Int", 2)?;
      s.serialize_field("bitWidth", &self.bitWidth())?;
      s.serialize_field("is_signed", &self.is_signed())?;
    s.end()
  }
}
...
impl Serialize for FloatingPoint<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("FloatingPoint", 1)?;
...
impl Serialize for Utf8<'_> {
  ...
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("Utf8", 0)?;
    s.end()
  }
}
...
impl Serialize for Binary<'_> {
  ...
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("Binary", 0)?;
    s.end()
  }
}
...
impl Serialize for LargeUtf8<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("LargeUtf8", 0)?;
    s.end()
  }
}
...
impl Serialize for LargeBinary<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("LargeBinary", 0)?;
    s.end()
  }
}
...
impl Serialize for FixedSizeBinary<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("FixedSizeBinary", 1)?;
      s.serialize_field("byteWidth", &self.byteWidth())?;
    s.end()
  }
}
...
impl Serialize for Bool<'_> {
  ...
  where
    S: Serializer,
  {
    let s = serializer.serialize_struct("Bool", 0)?;
    s.end()
  }
}
...
impl Serialize for Decimal<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Decimal", 3)?;
      s.serialize_field("precision", &self.precision())?;
...
impl Serialize for Interval<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Interval", 1)?;
      s.serialize_field("unit", &self.unit())?;
    s.end()
  }
}
...
impl Serialize for DictionaryEncoding<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("DictionaryEncoding", 4)?;
      s.serialize_field("id", &self.id())?;
      if let Some(f) = self.indexType() {
        s.serialize_field("indexType", &f)?;
      } else {
        s.skip_field("indexType")?;
      }
      s.serialize_field("isOrdered", &self.isOrdered())?;
      s.serialize_field("dictionaryKind", &self.dictionaryKind())?;
    s.end()
  }
}
...
impl Serialize for Field<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Field", 7)?;
      ...
      if let Some(f) = self.custom_metadata() {
        s.serialize_field("custom_metadata", &f)?;
      } else {
        s.skip_field("custom_metadata")?;
      }
    s.end()
  }
}
...
impl Serialize for Schema<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Schema", 4)?;
      ...
      if let Some(f) = self.features() {
        s.serialize_field("features", &f)?;
      } else {
        s.skip_field("features")?;
      }
    s.end()
  }
}
