...
impl Serialize for BaseType {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("BaseType", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl Serialize for Type<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Type", 6)?;
      s.serialize_field("base_type", &self.base_type())?;
      s.serialize_field("element", &self.element())?;
      s.serialize_field("index", &self.index())?;
      s.serialize_field("fixed_length", &self.fixed_length())?;
      s.serialize_field("base_size", &self.base_size())?;
      s.serialize_field("element_size", &self.element_size())?;
    s.end()
  }
}
...
impl Serialize for EnumVal<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("EnumVal", 6)?;
      s.serialize_field("name", &self.name())?;
      s.serialize_field("value", &self.value())?;
      if let Some(f) = self.union_type() {
        s.serialize_field("union_type", &f)?;
      } else {
        s.skip_field("union_type")?;
      }
      if let Some(f) = self.documentation() {
        s.serialize_field("documentation", &f)?;
      } else {
        s.skip_field("documentation")?;
      }
...
impl Serialize for Enum<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Enum", 7)?;
      s.serialize_field("name", &self.name())?;
      s.serialize_field("values", &self.values())?;
      s.serialize_field("is_union", &self.is_union())?;
      s.serialize_field("underlying_type", &self.underlying_type())?;
      if let Some(f) = self.attributes() {
        s.serialize_field("attributes", &f)?;
      } else {
        s.skip_field("attributes")?;
      ...
      if let Some(f) = self.declaration_file() {
        s.serialize_field("declaration_file", &f)?;
      } else {
        s.skip_field("declaration_file")?;
      }
    s.end()
  }
}
...
impl Serialize for Field<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Field", 14)?;
      s.serialize_field("name", &self.name())?;
      s.serialize_field("type_", &self.type_())?;
      s.serialize_field("id", &self.id())?;
      s.serialize_field("offset", &self.offset())?;
      s.serialize_field("default_integer", &self.default_integer())?;
      s.serialize_field("default_real", &self.default_real())?;
      ...
      s.serialize_field("offset64", &self.offset64())?;
    s.end()
  }
}
...
impl Serialize for Object<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Object", 8)?;
      s.serialize_field("name", &self.name())?;
      s.serialize_field("fields", &self.fields())?;
      s.serialize_field("is_struct", &self.is_struct())?;
      s.serialize_field("minalign", &self.minalign())?;
      s.serialize_field("bytesize", &self.bytesize())?;
      if let Some(f) = self.attributes() {
        s.serialize_field("attributes", &f)?;
      } else {
        s.skip_field("attributes")?;
...
impl Serialize for RPCCall<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("RPCCall", 5)?;
      s.serialize_field("name", &self.name())?;
...
impl Serialize for Service<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Service", 5)?;
      s.serialize_field("name", &self.name())?;
      if let Some(f) = self.calls() {
        s.serialize_field("calls", &f)?;
      } else {
        s.skip_field("calls")?;
      }
      if let Some(f) = self.attributes() {
...
impl Serialize for SchemaFile<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("SchemaFile", 2)?;
      s.serialize_field("filename", &self.filename())?;
      if let Some(f) = self.included_filenames() {
        s.serialize_field("included_filenames", &f)?;
      } else {
        s.skip_field("included_filenames")?;
      }
    s.end()
  }
}
...
impl Serialize for Schema<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Schema", 8)?;
      s.serialize_field("objects", &self.objects())?;
      s.serialize_field("enums", &self.enums())?;
      if let Some(f) = self.file_ident() {
        s.serialize_field("file_ident", &f)?;
      } else {
        s.skip_field("file_ident")?;
      }
      if let Some(f) = self.file_ext() {
        s.serialize_field("file_ext", &f)?;
      } else {
        s.skip_field("file_ext")?;
      }
      if let Some(f) = self.root_table() {
        s.serialize_field("root_table", &f)?;
      } else {
        s.skip_field("root_table")?;
      }
      if let Some(f) = self.services() {
        s.serialize_field("services", &f)?;
      } else {
        s.skip_field("services")?;
      }
      s.serialize_field("advanced_features", &self.advanced_features())?;
      if let Some(f) = self.fbs_files() {
        s.serialize_field("fbs_files", &f)?;
      } else {
        s.skip_field("fbs_files")?;
      }
    s.end()
  }
}
