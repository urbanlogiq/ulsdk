...
impl<'a> Model<'a> {
  ...
  pub fn source(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Model::VT_SOURCE, None)}
  }
  #[inline]
  pub fn location(&self) -> ObjectId<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<ObjectId>>(Model::VT_LOCATION, None).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for Model<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<ObjectId>>("location", Self::VT_LOCATION, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> ModelBuilder<'a, 'b> {
  ...
  pub fn add_source(&mut self, source: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Model::VT_SOURCE, source);
  }
  #[inline]
  pub fn add_location(&mut self, location: flatbuffers::WIPOffset<ObjectId<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<ObjectId>>(Model::VT_LOCATION, location);
  }
  #[inline]
