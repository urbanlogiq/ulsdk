...
impl Serialize for SparseMatrixCompressedAxis {
...
impl Serialize for SparseTensorIndexCOO<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("SparseTensorIndexCOO", 4)?;
        s.serialize_field("indicesType", &self.indicesType())?;
        if let Some(f) = self.indicesStrides() {
            s.serialize_field("indicesStrides", &f)?;
        } else {
            s.skip_field("indicesStrides")?;
        }
        s.serialize_field("indicesBuffer", &self.indicesBuffer())?;
        s.serialize_field("isCanonical", &self.isCanonical())?;
        s.end()
    }
}
...
impl Serialize for SparseMatrixIndexCSX<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("SparseMatrixIndexCSX", 5)?;
        s.serialize_field("compressedAxis", &self.compressedAxis())?;
        s.serialize_field("indptrType", &self.indptrType())?;
        s.serialize_field("indptrBuffer", &self.indptrBuffer())?;
        s.serialize_field("indicesType", &self.indicesType())?;
        s.serialize_field("indicesBuffer", &self.indicesBuffer())?;
        s.end()
    }
...
impl Serialize for SparseTensorIndexCSF<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("SparseTensorIndexCSF", 5)?;
        s.serialize_field("indptrType", &self.indptrType())?;
        s.serialize_field("indptrBuffers", &self.indptrBuffers())?;
        s.serialize_field("indicesType", &self.indicesType())?;
        s.serialize_field("indicesBuffers", &self.indicesBuffers())?;
        s.serialize_field("axisOrder", &self.axisOrder())?;
        s.end()
    }
}
...
impl Serialize for SparseTensor<'_> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let mut s = serializer.serialize_struct("SparseTensor", 7)?;
        ...
        s.serialize_field("non_zero_length", &self.non_zero_length())?;
        s.serialize_field("sparseIndex_type", &self.sparseIndex_type())?;
        match self.sparseIndex_type() {
            SparseTensorIndex::NONE => (),
            SparseTensorIndex::SparseTensorIndexCOO => {
                let f = self.sparseIndex_as_sparse_tensor_index_coo().expect(
                    "Invalid union table, expected `SparseTensorIndex::SparseTensorIndexCOO`.",
                );
                s.serialize_field("sparseIndex", &f)?;
            }
            SparseTensorIndex::SparseMatrixIndexCSX => {
                let f = self.sparseIndex_as_sparse_matrix_index_csx().expect(
                    "Invalid union table, expected `SparseTensorIndex::SparseMatrixIndexCSX`.",
                );
                s.serialize_field("sparseIndex", &f)?;
            }
            SparseTensorIndex::SparseTensorIndexCSF => {
                let f = self.sparseIndex_as_sparse_tensor_index_csf().expect(
                    "Invalid union table, expected `SparseTensorIndex::SparseTensorIndexCSF`.",
                );
                s.serialize_field("sparseIndex", &f)?;
            }
            _ => unimplemented!(),
