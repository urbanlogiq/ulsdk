...
def AddCompressedAxis(builder, compressedAxis):
    SparseMatrixIndexCSXAddCompressedAxis(builder, compressedAxis)
...
def AddIndptrType(builder, indptrType):
    SparseMatrixIndexCSXAddIndptrType(builder, indptrType)
...
def AddIndptrBuffer(builder, indptrBuffer):
    SparseMatrixIndexCSXAddIndptrBuffer(builder, indptrBuffer)
...
def AddIndicesType(builder, indicesType):
    SparseMatrixIndexCSXAddIndicesType(builder, indicesType)
...
def AddIndicesBuffer(builder, indicesBuffer):
    SparseMatrixIndexCSXAddIndicesBuffer(builder, indicesBuffer)

def SparseMatrixIndexCSXEnd(builder):
    return builder.EndObject()

def End(builder):
    return SparseMatrixIndexCSXEnd(builder)
