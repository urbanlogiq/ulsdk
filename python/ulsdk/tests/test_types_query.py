...
def test_mvdb_partition():
    _t0 = MvdbPartition.make_default()
    _b = _t0.to_bytes()
    _t1 = MvdbPartition.from_bytes(_b)
    assert _t0 == _t1
...
def test_placeholder():
    _t0 = Placeholder.make_default()
    _b = _t0.to_bytes()
    _t1 = Placeholder.from_bytes(_b)
    assert _t0 == _t1
...
def test_table_source_instance():
    _t0 = TableSourceInstance.make_default()
    _b = _t0.to_bytes()
...
def test_worklog_partition():
    ...
    _b = _t0.to_bytes()
    _t1 = WorklogPartition.from_bytes(_b)
    assert _t0 == _t1
